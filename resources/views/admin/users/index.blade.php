<x-admin-layout>
    ...
    <div class="mt-12 max-w-6xl mx-auto">
        <div class="flex justify-between m-2 p-2">
            ...
            <a href="{{ route('admin.users.import') }}" class="px-4 py-2 transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 bg-indigo-400 hover:bg-indigo-600 rounded">
                Upload Excel File</a>

            <a href="{{ route('admin.users.create') }}" class="px-4 py-2 transition ease-in-out delay-100 hover:-translate-y-1 hover:scale-110 bg-indigo-400 hover:bg-indigo-600 rounded">
                Add New User</a>
